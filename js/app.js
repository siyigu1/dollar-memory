...
(function () {
  ...
  function renderAbout(container) {
    container.innerHTML = ''
      ...
      + '        <a href="ENTER_X_URL" target="_blank" rel="noopener" class="about-link">'
      + '          <span class="about-link-icon">𝕏</span><span>' + t('about.x') + '</span></a>'
      + '        <a href="ENTER_XHS_URL" target="_blank" rel="noopener" class="about-link">'
      + '          <span class="about-link-icon">📕</span><span>' + t('about.xhs') + '</span></a>'
      + '        <a href="mailto:ENTER_EMAIL" class="about-link">'
